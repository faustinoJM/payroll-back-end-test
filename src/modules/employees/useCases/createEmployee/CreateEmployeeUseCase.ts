...
class CreateEmployeeUseCase {
    ...
    async execute({ employee_id, name, salary, dependents, position_id, department_id }: ICreateEmployeeDTO) {
        ...
        await this.userRepository.create({ employee_id, name, dependents, salary, position_id, department_id });
